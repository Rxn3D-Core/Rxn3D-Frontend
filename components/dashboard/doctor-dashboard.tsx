...
import { Search, Eye, Plus, Calendar, FileText, Users, Clock, CheckCircle, CirclePause, CircleOff, EllipsisVertical, MoreHorizontal } from 'lucide-react'
...
export function DoctorDashboard() {
  ...
  const mockAppointments: Array<{ id: number; patientName: string; time: string; type: string }> = []
    ...
    <div className="p-3 sm:p-4 md:p-6 lg:p-8 xl:p-12 bg-white min-h-screen">
      <div className="space-y-4 sm:space-y-6 lg:space-y-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
          ...
          <StatusCard title="Approved" count={5} color="text-green-500" />
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="max-h-80 sm:max-h-96 overflow-y-auto">
              {mockCases.length > 0 ? (
                ...
                <div className="p-8 sm:p-12 text-center">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">Create a new case to get started.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-[#d9d9d9] overflow-hidden">
            <div className="p-3 sm:p-4 border-b border-[#d9d9d9] bg-[#1162a8]">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-base sm:text-lg font-semibold text-white mb-1">Appointments</h2>
            ...
            <div className="max-h-80 sm:max-h-96 overflow-y-auto">
              {mockAppointments.length > 0 ? (
                ...
                <div className="p-8 sm:p-12 text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">No appointments found</h3>
