        ...
        {(shouldExpand || isMobileOverlay) ? (
          ...
          <div className="flex items-center justify-center w-full">
            {customerId ? (
              ...
              <div className="text-xl sm:text-2xl md:text-3xl font-bold text-[#1162a8] rounded-full w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 flex items-center justify-center">R</div>
            )}
          </div>
        )}
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        >
          <div className="flex items-center">
            ...
            {(shouldExpand || isMobileOverlay) && (
              <span className="ml-2 sm:ml-3 text-[14px] font-['Verdana'] font-normal leading-[100%] tracking-[0%] text-[#000000]">
                {t("menu.logout", "Sign Out")}
              </span>
            )}
          </div>
