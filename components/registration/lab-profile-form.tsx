      ...
      <div className="space-y-4">
        ...
        <div className="mt-8">
          <div className="flex flex-col items-center">
            ...
            <label className={`bg-[linear-gradient(256.66deg,#2AA6DE_0%,#82298D_50%,#C9539F_100%)] text-white px-4 py-2 rounded flex items-center cursor-pointer ${fileSizeError ? 'opacity-90' : ''}`}>
