...
const SHAPES = [
    {
        id: 'incomplete-circle', name: 'Incomplete Circle', getIcon: (color: string) => (
    ...
    {
        id: 'crescent', name: 'Crescent', getIcon: (color: string) => (
    ...
    {
        id: 'diamond', name: 'Diamond', getIcon: (color: string) => (
    ...
    {
        id: 'square', name: 'Square', getIcon: (color: string) => (
            <svg width="42" height="42" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        id: 'octagon', name: 'Octagon', getIcon: (color: string) => (
            <svg width="42" height="42" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        id: 'triangle', name: 'Triangle', getIcon: (color: string) => (
    ...
    {
        id: 'star', name: 'Star', getIcon: (color: string) => (
            <svg width="42" height="42" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        id: 'pentagon', name: 'Pentagon', getIcon: (color: string) => (
            <svg width="42" height="42" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        id: 'starburst', name: 'Starburst', getIcon: (color: string) => (
            <svg width="42" height="42" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function CreateRetentionOptionModal({ isOpen, onClose, option, isCopying = false }: CreateRetentionOptionModalProps) {
    const { user } = useAuth()
    ...
    const handleSave = async () => {
        ...
        try {
            // TODO: Implement API call to create/update retention option
            const payload: any = {
            ...
            if (option && option.id && !isCopying) {
                ...
                console.log("Update retention option:", payload)
            } else {
                // Create new option
                console.log("Create retention option:", payload)
            }

            toast({
                title: "Success",
                description: option && option.id ? "Retention option updated successfully" : "Retention option created successfully",
            })
