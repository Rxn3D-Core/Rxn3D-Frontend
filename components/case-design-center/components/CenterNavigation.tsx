export function CenterNavigation() {
  ...
  return (
    <div className="flex flex-col items-center justify-start pt-8 flex-shrink-0 order-2 lg:order-none w-auto">
      {/* Arrows are absolutely positioned so they overlay the adjacent tooth charts
          without adding any width to this column */}
      <div className="relative flex items-center justify-center" aria-label="Teeth in mouth status">
        {/* Left arrow — overlays into the maxillary chart area */}
        <svg
          width={arrowWidth}
          height={arrowHeight}
          viewBox="0 0 70 5"
          ...
          className="absolute right-full hidden sm:block pointer-events-none"
        ...
        {/* Right arrow — overlays into the mandibular chart area */}
        <svg
          width={arrowWidth}
          height={arrowHeight}
          viewBox="0 0 70 5"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute left-full hidden sm:block pointer-events-none"
