      ...
      {showMaxillary && (
        <>
            ...
            .map((ap) => {
              ...
              return (
                <ProductAccordionCard
                  ...
                  onToggle={() => {
                    toggleCard(slotId);
                    setActiveProductCardId(isCardExpanded(slotId) ? 0 : ap.id);
                            ...
                            <div className="rounded-lg p-3 space-y-3">
                              ...
                              {isF("impression") && (
                                <fieldset
                                  ...
                                  onClick={() => handleOpenImpressionModal("maxillary", impressionModalProductId, repTn)}
                                >
          ...
          {showDetails && maxillaryHasRemovablesCard0 && (() => {
            ...
            return (
              <div key="initial-removables-maxillary" className="relative mt-4">
                    ...
                    <div className="px-[14px] py-[14px] flex flex-col gap-[10px]">
                      <fieldset
                        ...
                        onClick={() => {
                          ...
                          handleOpenImpressionModal("mandibular", "0", 17);
                        }}
                      >
