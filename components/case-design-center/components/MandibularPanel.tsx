                        ...
                        {categoryName === "Fixed Restoration" ? (
                          <>
                            ...
                            {isFixed("fixed_contact_icons") && hasAdvanceField("fixed_contact_icons", selectedProduct?.advance_fields) && (() => {
                              ...
                              if (contactFields.length === 0) {
                                ...
                                if (!isFieldCompleted("mandibular", firstToothNumber, "fixed_contact_icons")) {
                                  completeFieldStep("mandibular", firstToothNumber, "fixed_contact_icons", "auto");
                                }
                                return null;
                              }
                              const fieldVal = getFieldValue("mandibular", firstToothNumber, "fixed_contact_icons");
                              ...
                              return (
                                <div className={`grid gap-3`} style={{ gridTemplateColumns: `repeat(${colCount}, minmax(0, 1fr))` }}>
                                  {visibleFields.map((field) => {
                                    ...
                                    if (!hasFieldOptions) {
                                      const stepCompleted = isFieldCompleted("mandibular", firstToothNumber, "fixed_contact_icons");
                                      return (
                                        <fieldset
                                          key={field.id}
                                    ...
                                    return (
                                      <AdvanceFieldSelect
                                        ...
                                        onSelect={(opt) => {
                                          ...
                                          if (allFilled) {
                                            completeFieldStep("mandibular", firstToothNumber, "fixed_contact_icons", JSON.stringify(updated));
                                          } else {
                                            storeFieldValue("mandibular", firstToothNumber, "fixed_contact_icons", JSON.stringify(updated));
                                            uncompleteFieldStep("mandibular", firstToothNumber, "fixed_contact_icons");
                                          }
                                        }}
                                      />
                                    );
                            ...
                            {isFixed("fixed_proximal_contact") && hasAdvanceField("fixed_proximal_contact", selectedProduct?.advance_fields) && (() => {
                              ...
                              if (proximalFields.length === 0) {
                                if (!isFieldCompleted("mandibular", firstToothNumber, "fixed_proximal_contact")) {
                                  completeFieldStep("mandibular", firstToothNumber, "fixed_proximal_contact", "auto");
                                }
                                return null;
                              }
                              const fieldVal = getFieldValue("mandibular", firstToothNumber, "fixed_proximal_contact");
                              let storedValues: Record<string, { name: string; optionId: number }> = {};
                              try { if (fieldVal && fieldVal.startsWith("{")) storedValues = JSON.parse(fieldVal); } catch {}
                              ...
                              return (
                                <div className={`grid gap-3`} style={{ gridTemplateColumns: `repeat(${colCount}, minmax(0, 1fr))` }}>
                                  {visibleFields.map((field) => {
                                    ...
                                    if (!hasFieldOptions) {
                                      const stepCompleted = isFieldCompleted("mandibular", firstToothNumber, "fixed_proximal_contact");
                                      return (
                                        <fieldset
                                          key={field.id}
                                          className={`border rounded px-3 py-0 relative h-[42px] flex items-center ${
                                    ...
                                    return (
                                      <AdvanceFieldSelect
                                        ...
                                        onSelect={(opt) => {
                                          ...
                                          const allFilled = fieldsWithOptions.every((f) => updated[f.id]);
                                          if (allFilled) {
                                            completeFieldStep("mandibular", firstToothNumber, "fixed_proximal_contact", JSON.stringify(updated));
                                          } else {
                                            storeFieldValue("mandibular", firstToothNumber, "fixed_proximal_contact", JSON.stringify(updated));
                                            uncompleteFieldStep("mandibular", firstToothNumber, "fixed_proximal_contact");
                                          }
                                        }}
                                      />
                                    );
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                {isFixed("fixed_addons") ? (
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center gap-2 w-full">
                                      <span className="text-[14px] sm:text-lg text-[#000000] truncate">
                                        {getFieldValue("mandibular", firstToothNumber, "fixed_addons") || "No add on selected"}
                                      </span>
                          ...
                          <>
                            ...
                            {isFieldVisible("mandibular", firstToothNumber, "grade") && (() => {
                              const gradeRaw = getFieldValue("mandibular", firstToothNumber, "grade") || "";
                              let gradeVal = gradeRaw;
                              try { const p = JSON.parse(gradeRaw); gradeVal = p.name ?? gradeRaw; } catch {}
                              const isGradeComplete = isFieldCompleted("mandibular", firstToothNumber, "grade");
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                >
                                  ...
                                  <GradeHoverSelector
                                    ...
                                    onSelect={(g) => completeFieldStep("mandibular", firstToothNumber, "grade", JSON.stringify({ grade_id: g.grade_id, name: g.name }))}
                                  />
                                  {showGradeGreen && (
                            ...
                            {isFieldVisible("mandibular", firstToothNumber, "teeth_shade") && (
                              ...
                              />
                              <AutoOpenGumShade
                                visible={isFieldVisible("mandibular", firstToothNumber, "gum_shade")}
                                hasValue={isFieldCompleted("mandibular", firstToothNumber, "gum_shade")}
                                onOpen={() => setPanelGumShadePicker({ toothNumber: firstToothNumber, gumShades: cardProduct?.gum_shades || [] })}
                              />
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
                                ...
                                >
                                  ...
                                  <div className="flex items-center gap-2 w-full">
                                    <span className="text-[14px] sm:text-lg text-[#000000]">
                                      {(() => { const r = getFieldValue("mandibular", firstToothNumber, "teeth_shade"); try { return JSON.parse(r).name ?? r; } catch { return r; } })()}
                                    </span>
                                    {isFieldCompleted("mandibular", firstToothNumber, "teeth_shade") && !caseSubmitted && (
                                      <Check size={16} className="text-[#34a853] ml-auto" />
                                    )}
                                ...
                                {isFieldVisible("mandibular", firstToothNumber, "gum_shade") ? (
                                  <fieldset
                                    ...
                                    onClick={() => {
                                      if (!caseSubmitted) {
                                        uncompleteFieldStep("mandibular", firstToothNumber, "gum_shade");
                                        setPanelGumShadePicker({ toothNumber: firstToothNumber, gumShades: cardProduct?.gum_shades || [] });
                                      }
                                    }}
                                  >
                                    <legend
                                    ...
                                    <div className="flex items-center gap-2 w-full">
                                      {(() => {
                                        const raw = getFieldValue("mandibular", firstToothNumber, "gum_shade");
                                        let displayName = raw;
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
                                ...
                                {isFieldVisible("mandibular", firstToothNumber, "addons") ? (
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center gap-2 w-full">
                                      <span className="text-[14px] sm:text-lg text-[#000000] truncate">
                                        {getFieldValue("mandibular", firstToothNumber, "addons") || "No add on selected"}
                                      </span>
                                      {isFieldCompleted("mandibular", firstToothNumber, "addons") && !caseSubmitted && (
                                        <Check size={16} className="text-[#34a853] ml-auto" />
                                      )}
                              ...
                              <>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                  ...
                                  <fieldset
                                    ...
                                    onClick={() => {
                                      if (!caseSubmitted) {
                                        uncompleteFieldStep("mandibular", repTn, "gum_shade");
                            ...
                            <div className="border border-[#e5e7eb] rounded-lg p-3 space-y-3">
                              ...
                              {(isFixed ? isF("fixed_addons") : isF("addons")) && (
                                ...
                                >
                                  ...
                                  <span className="text-[14px] sm:text-lg text-[#000000] truncate flex-1">{fVal(isFixed ? "fixed_addons" : "addons") || "No add on selected"}</span>
