...
import { X, HelpCircle, Edit, Copy, Trash2, Search } from "lucide-react"
...
export function AddAbutmentModal({ isOpen, onClose, onSave }: AddAbutmentModalProps) {
  ...
  const [formData, setFormData] = useState({
    brandName: "Straumann",
    systemName: "Bone Level Abutments (BL)",
    allowUserInput: true,
    description: "",
  ...
  const [pricingData, setPricingData] = useState({
    canAddAdditionalCharges: true,
    chargeType: "once-per-field" as "once-per-field" | "per-selected-option",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-2 sm:p-4">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-6xl h-full max-h-[95vh] sm:h-auto sm:max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 flex-shrink-0">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Add Abutment</h2>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center gap-2 mb-2">
                <Label className="text-sm sm:text-base font-medium">Abutment details</Label>
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div>
                ...
                <Input
                  id="systemName"
                  placeholder="Bone Level Abutments (BL)"
                ...
                <table className="w-full min-w-[600px]">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      {pricingData.chargeType === "per-selected-option" && (
                ...
                <>
                  ...
                  <div>
                    <RadioGroup
                      ...
                      onValueChange={(value: "once-per-field" | "per-selected-option") =>
                    ...
                    >
                      <label
                        htmlFor="charge-once"
                        onClick={() => setPricingData({ ...pricingData, chargeType: "once-per-field" })}
                        className="border border-gray-200 rounded-lg p-4 hover:border-[#1162a8] transition-colors cursor-pointer block"
                      >
                        <div className="flex items-start gap-3">
                          <RadioGroupItem value="once-per-field" id="charge-once" className="mt-0.5" />
                      ...
                      <label
                        ...
                        onClick={() => setPricingData({ ...pricingData, chargeType: "per-selected-option" })}
                        className="border border-gray-200 rounded-lg p-4 hover:border-[#1162a8] transition-colors cursor-pointer block"
                      >
                        <div className="flex items-start gap-3">
                          <RadioGroupItem value="per-selected-option" id="charge-per-option" className="mt-0.5" />
                          <div className="flex-1">
                            <div className="text-sm font-medium text-gray-900 cursor-pointer block mb-1">
