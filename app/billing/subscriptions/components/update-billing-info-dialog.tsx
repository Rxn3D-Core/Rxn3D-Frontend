...
export function UpdateBillingInfoDialog({ open, onOpenChange }: UpdateBillingInfoDialogProps) {
  return (
      ...
      <DialogContent showCloseButton={false} className="w-[min(520px,calc(100vw-24px))] max-w-none overflow-hidden rounded-[10px] border-0 bg-white p-0 shadow-2xl">
        ...
        <div className="px-6 pb-6 pt-5">
          ...
          <div className="mt-6 flex items-center justify-end gap-5">
            ...
            <button
              type="button"
              className="inline-flex h-9 w-[180px] items-center justify-center gap-2 rounded-[6px] bg-[#1162A8] text-[13px] font-semibold leading-4 text-white transition-colors hover:bg-[#0E548F]"
            >
